...
<body>
    ...
    <main class="container-fluid my-4 flex-grow-1">
        <h2 class="mb-4 fw-bold text-gradient">Authority Dashboard</h2>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-3 shadow-custom">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Assigned Reports Map</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card mb-3 shadow-custom">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Assigned Reports</h5>
                    </div>
                    <div class="card-body">
                        <p class="text-muted small mb-3">Reports assigned to your authority</p>
